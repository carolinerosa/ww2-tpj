...
public class TratamentoFimDEJogo extends View{
	...
	/**
	 * Classe que tratar� os dados do Time para serem mostrados em FimDeJogoActivity
	 * @param time ArrayList de <code>DadosJogador</code> que ser� usado para coletar a vari�vel matou e morreu.
